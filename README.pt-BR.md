...
- artefatos processados com validação e contratos versionados
...
- Postgres é um alvo opcional de compatibilidade, inclusive com smoke em schema prefixado quando houver credenciais.
...
Somente `data/processed/metrics_report.json` permanece versionado como artefato leve de referência para reviewers.
